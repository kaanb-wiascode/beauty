...
import { FinancialIntegrationPermissionGuard, RequireFinancialIntegrationPermission } from './financial-integration-permission.guard';
import { FinancialIntegrationAuditInterceptor, AuditFinancialIntegrationAction } from './financial-integration-audit.interceptor';
import { FinancialIntegrationRateLimitGuard, FinancialIntegrationRateLimit } from './financial-integration-rate-limit.guard';
...
@UseGuards(JwtAuthGuard, TenantAuthGuard, FinancialIntegrationPermissionGuard, FinancialIntegrationRateLimitGuard)
...
export class FinancialIntegrationsController {
  ...
  create(@Body() body: unknown) { return this.service.create(createSchema.parse(body)); }
  ...
  disconnect(@Param('id') id: string) { return this.connection.disconnect(id); }
}
