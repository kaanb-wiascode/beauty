...
@Module({
  ...
  controllers:[TrainingController,TrainingAnalyticsController,TrainingAuthoringController,TrainingBranchAnalyticsController,TrainingBulkAssignmentController,TrainingLearnerController,TrainingLearnerAssessmentController,TrainingLearnerPathController,TrainingLearningPathController,TrainingReminderController,TrainingRoleAcademyController,TrainingPracticalRubricController,TrainingQuestionBankController,TrainingContentStorageController,TrainingCourseLifecycleController,TrainingCourseModuleController,CompetencyController,CompetencyReviewController,CompetencyTrainingController,LmsController,PositionCompetencyController,TrainingCertificateController,TrainingCompetencyBridgeController,TrainingEffectivenessController,TrainingEffectivenessFollowupController,TrainingLessonProgressController,TrainingPlanningController,TrainingProgramController],
  providers:[TrainingService,TrainingAnalyticsService,TrainingAuthoringService,TrainingBranchAnalyticsService,TrainingBulkAssignmentService,TrainingLearnerService,TrainingLearnerAssessmentService,TrainingLearnerPathService,TrainingLearningPathService,TrainingReminderService,TrainingRoleAcademyService,TrainingPracticalRubricService,TrainingQuestionBankService,TrainingContentStorageService,TrainingCourseLifecycleService,TrainingCourseModuleService,TrainingDevelopmentPlanService,CompetencyService,CompetencyReviewService,CompetencyTrainingService,LmsService,PositionCompetencyService,TrainingCertificateService,TrainingCompetencyBridgeService,TrainingEffectivenessService,TrainingEffectivenessFollowupService,TrainingLessonProgressService,TrainingPlanningService,TrainingProgramService],
  exports:[TrainingService,TrainingAnalyticsService,TrainingAuthoringService,TrainingBranchAnalyticsService,TrainingBulkAssignmentService,TrainingLearnerService,TrainingLearnerAssessmentService,TrainingLearnerPathService,TrainingLearningPathService,TrainingReminderService,TrainingRoleAcademyService,TrainingPracticalRubricService,TrainingQuestionBankService,TrainingContentStorageService,TrainingCourseLifecycleService,TrainingCourseModuleService,TrainingDevelopmentPlanService,CompetencyService,CompetencyReviewService,CompetencyTrainingService,LmsService,PositionCompetencyService,TrainingCertificateService,TrainingCompetencyBridgeService,TrainingEffectivenessService,TrainingEffectivenessFollowupService,TrainingLessonProgressService,TrainingPlanningService,TrainingProgramService],
})
