...
@Module({
  ...
  providers:[TrainingService,TrainingAnalyticsService,TrainingAuthoringService,TrainingBranchAnalyticsService,TrainingQuestionBankService,TrainingContentStorageService,TrainingCourseLifecycleService,CompetencyService,CompetencyReviewService,CompetencyTrainingService,LmsService,PositionCompetencyService,TrainingCertificateService,TrainingCompetencyBridgeService,TrainingEffectivenessService,TrainingEffectivenessFollowupService,TrainingLessonProgressService,TrainingPlanningService,TrainingProgramService],
  exports:[TrainingService,TrainingAnalyticsService,TrainingAuthoringService,TrainingBranchAnalyticsService,TrainingQuestionBankService,TrainingContentStorageService,TrainingCourseLifecycleService,CompetencyService,CompetencyReviewService,CompetencyTrainingService,LmsService,PositionCompetencyService,TrainingCertificateService,TrainingCompetencyBridgeService,TrainingEffectivenessService,TrainingEffectivenessFollowupService,TrainingLessonProgressService,TrainingPlanningService,TrainingProgramService],
})
