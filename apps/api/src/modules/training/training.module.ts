...
@Module({
  ...
  controllers:[TrainingController,TrainingAnalyticsController,TrainingAuthoringController,TrainingBranchAnalyticsController,TrainingBulkAssignmentController,TrainingLearnerController,TrainingLearnerAssessmentController,TrainingReminderController,TrainingPracticalRubricController,TrainingQuestionBankController,TrainingContentStorageController,TrainingCourseLifecycleController,TrainingCourseModuleController,CompetencyController,CompetencyReviewController,CompetencyTrainingController,LmsController,PositionCompetencyController,TrainingCertificateController,TrainingCompetencyBridgeController,TrainingEffectivenessController,TrainingEffectivenessFollowupController,TrainingLessonProgressController,TrainingPlanningController,TrainingProgramController],
  providers:[TrainingService,TrainingAnalyticsService,TrainingAuthoringService,TrainingBranchAnalyticsService,TrainingBulkAssignmentService,TrainingLearnerService,TrainingLearnerAssessmentService,TrainingReminderService,TrainingPracticalRubricService,TrainingQuestionBankService,TrainingContentStorageService,TrainingCourseLifecycleService,TrainingCourseModuleService,CompetencyService,CompetencyReviewService,CompetencyTrainingService,LmsService,PositionCompetencyService,TrainingCertificateService,TrainingCompetencyBridgeService,TrainingEffectivenessService,TrainingEffectivenessFollowupService,TrainingLessonProgressService,TrainingPlanningService,TrainingProgramService],
  exports:[TrainingService,TrainingAnalyticsService,TrainingAuthoringService,TrainingBranchAnalyticsService,TrainingBulkAssignmentService,TrainingLearnerService,TrainingLearnerAssessmentService,TrainingReminderService,TrainingPracticalRubricService,TrainingQuestionBankService,TrainingContentStorageService,TrainingCourseLifecycleService,TrainingCourseModuleService,CompetencyService,CompetencyReviewService,CompetencyTrainingService,LmsService,PositionCompetencyService,TrainingCertificateService,TrainingCompetencyBridgeService,TrainingEffectivenessService,TrainingEffectivenessFollowupService,TrainingLessonProgressService,TrainingPlanningService,TrainingProgramService],
})
