...
type HrBody = Record<string, unknown>;
...
@Post('employees')createEmployee(@Body()body:HrBody){return this.hrService.createEmployee(body);}
@Patch('employees/:id')updateEmployee(@Param('id')id:string,@Body()body:HrBody){return this.hrService.updateEmployee(id,body);}
...
@Post('attendance')saveAttendance(@Body()body:HrBody){return this.hrService.upsertAttendance(body);}
@Get('leaves')leaves(){return this.hrService.leaves();}
@Post('leaves')createLeave(@Body()body:HrBody){return this.hrService.createLeave(body);}
@Patch('leaves/:id')updateLeave(@Param('id')id:string,@Body()body:HrBody){return this.hrService.updateLeave(id,body);}
...
@Post('payments')createPayment(@Body()body:HrBody){return this.hrService.createPayment(body);}
...
@Post('sgk')createSgk(@Body()body:HrBody){return this.hrService.createSgk(body);}}
