...
export class ProfitabilityController {
  ...
  @Post('staff/:staffId/commission') setStaffCommission(@Param('staffId') staffId: string, @Body() body: unknown) { return this.config.setStaffCommission(staffId, commissionSchema.parse(body).rate); }
  @Post('sale-items/:saleItemId/attribute') attributeSaleItem(@Param('saleItemId') saleItemId: string, @Body() body: unknown) { return this.config.attributeSaleItem(saleItemId, attributionSchema.parse(body).appointmentId); }
  @Post('cost-centers') createCostCenter(@Body() body: unknown) { return this.costCenters.create(createCostCenterSchema.parse(body)); }
  ...
  @Post('cost-centers/:id/allocations') setCostCenterAllocations(@Param('id') id: string, @Body() body: unknown) { return this.costCenters.setAllocations(id, allocationSchema.parse(body)); }
  @Post('journal-lines/:journalEntryLineId/cost-center') assignExpenseLine(@Param('journalEntryLineId') journalEntryLineId: string, @Body() body: unknown) { return this.costCenters.assignExpenseLine(journalEntryLineId, assignExpenseSchema.parse(body).costCenterId); }
  @Post('budgets') upsertBudget(@Body() body: unknown) { return this.budgeting.upsert(budgetSchema.parse(body)); }
  ...
  @Post('treasury/settings') setTreasurySettings(@Body() body: unknown) { return this.treasuryRisk.setSettings(treasurySettingsSchema.parse(body)); }
  ...
  @Post('cfo/health/thresholds') setFinancialHealthThresholds(@Body() body: unknown) { return this.financialHealth.setThresholds(healthThresholdSchema.parse(body)); }
