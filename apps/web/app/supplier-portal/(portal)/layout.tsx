        ...
        <div className="mx-auto flex min-h-[72px] max-w-[1380px] flex-wrap items-center justify-between gap-4 px-5 py-3 sm:px-8">
          <div className="flex items-center gap-5">
            ...
            <nav className="hidden items-center gap-1 md:flex">
              <Link href="/supplier-portal/rfqs" className="rounded-[10px] px-3 py-2 text-[12px] font-semibold text-[#4f5d69] hover:bg-[#f0f4f7] hover:text-[#17212b]">Teklif Talepleri Ve Teklifler</Link>
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              ...
              <p className="text-[10px] text-[#7a8792]">{userLabel(session.membership.role)} · {userLabel(session.supplierOrganization.verificationStatus)}</p>
            </div>
            <button type="button" onClick={logout} className="rounded-[10px] border border-[#dfe7ed] bg-white px-3 py-2 text-[11px] font-semibold text-[#667482] hover:text-[#17212b]">Çıkış Yap</button>
          </div>
        </div>
        <nav className="mx-auto flex max-w-[1380px] gap-2 overflow-x-auto border-t border-[#eef2f5] px-5 py-2 md:hidden sm:px-8">
          <Link href="/supplier-portal/rfqs" className="whitespace-nowrap rounded-[10px] px-3 py-2 text-[12px] font-semibold text-[#4f5d69] hover:bg-[#f0f4f7]">Teklif Talepleri Ve Teklifler</Link>
