...
{title:"Takas Talebini Kabul Et",path:"/hr/workforce/exchange/swaps/{id}/accept",fields:[{name:"id",label:"Takas Talep ID",required:true},{name:"targetAssignmentId",label:"Hedef Vardiya Atama ID"},{name:"note",label:"Kabul Notu",type:"textarea"}]},
