...
export default function CrmOverviewPage() {
  ...
  const metricCards = [
    { label: "Yeni Potansiyel Müşteri", value: metrics.newLeads, detail: "İlk temas bekliyor", href: "/crm/leads" },
    { label: "Açık Fırsat", value: metrics.openOpportunities, detail: "Aktif satış süreci", href: "/crm/pipeline" },
    { label: "Ağırlıklı Satış Fırsatları", value: formatMoney(metrics.weightedPipeline), detail: "Kazanma olasılığına göre", href: "/crm/pipeline" },
