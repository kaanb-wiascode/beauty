...
export default function StaffPage() {
  ...
  function openCreate() {
    ...
    if (!hasActiveBranch()) {
      showToast("Yeni personel oluşturmak için önce çalışma kapsamından bir şube seçin.", "error");
      return;
    }
  ...
  async function onSubmit(event: FormEvent) {
    ...
    if (!editing && !hasActiveBranch()) {
      setFormError("Yeni personel oluşturmak için önce çalışma kapsamından bir şube seçin.");
      return;
    }
