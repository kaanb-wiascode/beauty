...
function Quick({label,onClick}:{label:string;onClick:()=>void}){return <button type="button" onClick={onClick} className="quick-action"><b className="quick-action-label">{label}</b><span className="quick-action-arrow"><ArrowRightIcon/></span></button>}
