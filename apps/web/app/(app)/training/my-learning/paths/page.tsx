...
export default function MyLearningPathsPage(){
  ...
  const load=useCallback(async()=>{setLoading(true);setError("");try{setRows(await api<PathRow[]>("/training/learner-paths/me"));}catch(e){setError(e instanceof ApiError?e.message:"Learning Path'leriniz yüklenemedi.");}finally{setLoading(false);}},[]);
