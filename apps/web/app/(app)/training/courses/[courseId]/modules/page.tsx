...
export default function TrainingCourseModulesPage(){
  ...
  return <div className="mx-auto max-w-[1440px] space-y-6 pb-10">
    ...
    {!canManage?<FinanceEmpty title="Salt Okunur Yetki" description="Modül authoring için training.manage izni gerekir."/>:!course.isActive?<FinanceEmpty title="Kurs Arşivde" description="Modül yapısı yalnızca aktif kursun taslak sürümünde değiştirilebilir."/>:!draft?<FinanceEmpty title="Aktif Taslak Yok" description="Önce İçerik & Assessment sekmesinden yeni bir taslak sürüm oluşturun."/>:<CourseModulesPanel versionId={draft.id} lessons={draft.lessons}/>} 
  </div>;
}
