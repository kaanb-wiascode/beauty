...
export default function TrainingAuthoringIndexPage(){
  ...
  return <div className="mx-auto max-w-[1440px] space-y-6 pb-10">
    <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-[var(--muted-soft)]">Öğrenme</p><h1 className="mt-1 text-[32px] font-semibold tracking-[-0.045em] text-[var(--ink)]">Kurs Yazarlığı</h1><p className="mt-2 max-w-[780px] text-[13px] leading-6 text-[var(--muted)]">Taslak kurs sürümlerini açın, ders ve değerlendirme içeriklerini yönetin; hazır sürümleri kontrollü biçimde yayınlayın.</p></div><Button variant="secondary" onClick={()=>void load()}>Yenile</Button></header>
