  ...
  return (
    <div className="space-y-6 pb-12">
      <header className="rounded-[24px] border border-[var(--line)] bg-[var(--surface)] p-6">
        ...
        <p className="mt-2 max-w-3xl text-[12px] leading-5 text-[var(--muted)]">İçeriklerin yayın akışına geçmeden önce kurumsal iletişim onayından geçmesini sağlayın. Kararlar kullanıcı, zaman ve açıklama ile audit trail&apos;e yazılır.</p>
      </header>
