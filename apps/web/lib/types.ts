...
export type CustomerHealthProfile = { allergies: string | null; sensitivities: string | null; medications: string | null; conditions: string | null; notes: string | null };
export type CustomerConsentType = "KVKK_ACKNOWLEDGEMENT" | "EXPLICIT_CONSENT" | "MEMBERSHIP_AGREEMENT" | "HEALTH_FORM_COMPLETION" | "HEALTH_DATA_CONSENT" | "MARKETING_SMS" | "MARKETING_EMAIL" | "MARKETING_PHONE";
export type CustomerConsent = { id: string; type: CustomerConsentType; status: "ACCEPTED" | "DECLINED"; documentVersion: string; acceptedAt: string | null; source: "WEB" | "STAFF" | "KIOSK" | "DIGITAL_SIGNATURE" };
